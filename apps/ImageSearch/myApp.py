...
class MyApp(object):
    ...
    def initExp(self, butler, init_algs, args):
        ...
        utils.debug_print('n: %d' % (n))
        utils.debug_print('d: %d' % (args['d']))
        utils.debug_print('f_prob: %f' % (args['failure_probability']))
        ...
        utils.debug_print('line 67: InitExp')
        utils.debug_print('Keys of alg_data:%s'% (alg_data.keys()))
        init_algs(alg_data)
